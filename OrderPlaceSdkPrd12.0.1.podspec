...
s.name = "OrderPlaceSdkPrd12.0.1"
s.version = "0.4.0"
s.summary = "Order Place Sdk swift5 Prd with Xcode12.0.1"

s.description = <<-DESC
a pod that easily implements the order.place function
DESC

s.homepage = "https://github.com/AigensTechnology/OrderPlaceSdkPrd12.0.1"
s.license = { :type => 'MIT', :file => 'LICENSE' }
s.author = { "风筝" => "13286953452@126.com" }

s.source = { :git => "https://github.com/AigensTechnology/OrderPlaceSdkPrd12.0.1.git", :tag => "#{s.version}" }
...
ali.libraries = 'z', 'c++'
ali.dependency 'OrderPlaceSdkPrd12.0.1/Core'
end
...
wechat.dependency 'OrderPlaceSdkPrd12.0.1/Core'
end
